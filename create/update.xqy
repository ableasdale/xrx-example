        ...
        <div id="container">
            ...
            <div id="main-content">
                <div id="cta" class="center">
                    ...
                    <p><a title="Return to the Project Dashboard" href="/default.xqy?projectChooser={local:getDocument()/TicketDocument/Ticket[1]/id[1]/text()}">Back to Dashboard for this Project</a></p>
